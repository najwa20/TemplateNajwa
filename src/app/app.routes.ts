...
import { AffairesComponent } from './modules/admin/dashboards/affaires/affaires.component';
import { DetailsComponent } from './modules/admin/dashboards/details/details.component';
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {path: 'dashboards', children: [
                {path: 'project', loadComponent: () => import('app/modules/admin/dashboards/affaires/affaires.component').then(m => m.AffairesComponent)},
                {path: 'analytics', loadComponent: () => import('app/modules/admin/dashboards/details/details.component').then (s => s.DetailsComponent)},
